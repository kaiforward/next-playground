 ...
 * Provisioned/band/memory/grievance read) for one system. Changes every economy tick — so, unlike
 * the static substrate read, it uses the default staleTime and is tick-invalidated (see
