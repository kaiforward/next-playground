 ...
 * (the arrival-driven partial visibility this hook's old docstring described was never wired — see
 * the client-runtime measure's side-finding), so this keeps that all-visible semantics: a
