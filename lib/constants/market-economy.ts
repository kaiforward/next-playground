...
/**
 * Months of cover (stock ÷ local demand rate) at which a good's mid price equals
 ...
 */
/**
 * Floor on the months-of-supply denominator so a near-empty system yields a finite
...
/**
 * Months-of-supply demand denominator for one good: max(civilian consumption,
...
/**
 * Total months-of-supply demand denominator: civilian (demand basis) + industrial
