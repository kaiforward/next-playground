...
/** Moved from `app/(game)/@panel/factions/[factionId]/factions/page.tsx` — the galaxy-wide faction
 *  list, every power, filterable, each card linking to its own panel. */
export function FactionFactions() {
