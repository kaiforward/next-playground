...
export function ConvoyRepairSlider({
  ...
  return (
    <Dialog
      ...
      onClose={onClose}
      modal
      className="backdrop:bg-black/60 top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 h-fit w-full max-w-md rounded-xl bg-gray-900 border border-white/10 shadow-2xl p-6"
    >
