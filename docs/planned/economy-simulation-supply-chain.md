...
Status: **Design locked** 2026-06-19; **Sub-Project 3 complete** 2026-06-20 (Part 1 — 26-good roster; Part 2 — industrial base & build space; Part 3 — supply-chain input-gating cascade). The shipped model is documented in [economy.md](../active/gameplay/economy.md) (production & consumption, the 26-good chain, input-gating, days-of-supply over total demand) and [system-traits.md](../active/gameplay/system-traits.md) §1.5 (build space & industrial base) — both active; this spec retains the full design rationale. The build plans (`docs/plans/sp3-*`) have been deleted. This is the sub-project spec for **Sub-Project 3** of the [Economy Simulation Vision](./economy-simulation-vision.md) (vision §13 item 3, "Supply-chain production + generic facilities"). It assumes the shipped SP1 model (physical substrate, population-scaled consumption, days-of-supply pricing) and SP2 model (dynamic population, unrest, strikes, migration). Read the [vision](./economy-simulation-vision.md) (§5 demand channels, §8 buildings & build space, §9 economy type dissolved), the [SP1 substrate spec](./economy-simulation-substrate.md), and the [SP2 living-world spec](./economy-simulation-living-world.md) first.
