...
- **[Faction System](../active/gameplay/faction-system.md)** — faction territories affect visibility (future)
- **[Universe](../active/gameplay/universe.md)** — current universe generation (will need scaling updates)
