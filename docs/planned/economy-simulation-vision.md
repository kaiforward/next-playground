...
2. **Demand & consequence loop** — population-scaled consumption, need-satisfaction recording, unrest, growth/decline, migration along lanes; days-of-supply pricing. This delivers the "living world."
...
- **Migration mechanics**: pull/push factors, rate, conservation rules, interaction with jump-lane topology.
- **Unrest → strike/rebellion thresholds**: how unrest accumulates and what triggers each consequence.
