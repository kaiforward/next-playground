...
**Depends on**: [Player Facilities](./player-facilities.md) (build system), [Economy](../active/gameplay/economy.md) (market integration), [System Traits](../active/gameplay/system-traits.md) (traits, economy types, population), [Faction System](../active/gameplay/faction-system.md) (war material demand)
...
Population is derived at world generation from system traits, not assigned independently. This keeps it consistent with the bottom-up trait system from [System Traits](../active/gameplay/system-traits.md).
...
| **Event impact** | Plague events hit harder at high-pop systems. Famine is more devastating. Already noted in [System Traits §4](../active/gameplay/system-traits.md) |
...
- **[Navigation](../active/gameplay/navigation.md)** — transport of goods between systems
