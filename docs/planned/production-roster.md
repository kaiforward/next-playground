...
**Depends on**: [Production](./production.md) (architecture), [Economy](../active/gameplay/economy.md) (existing goods), [System Traits](../active/gameplay/system-traits.md) (traits, economy types), [War System](./war-system.md) (military asset consumption)
...
**Status**: NPC rates for 14 new goods to be defined during implementation. These extend the existing rate tables in [Economy](../active/gameplay/economy.md). Key principles:
...
- **[Economy](../active/gameplay/economy.md)** — market simulation, NPC production/consumption rates
- **[System Traits (active)](../active/gameplay/system-traits.md)** — system traits, economy types, trait quality tiers
- **[Faction System](../active/gameplay/faction-system.md)** — war material demand, reputation
