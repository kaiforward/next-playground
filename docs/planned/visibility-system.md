...
**Depends on**: [Scalable Data Loading](./scalable-data-loading.md) (tile architecture), [Faction System](../active/gameplay/faction-system.md) (allied faction visibility, phase 2+), [Navigation](../active/gameplay/navigation.md) (ship positions and roles for sensor range)
...
- **[Faction System](../active/gameplay/faction-system.md)** — faction reputation drives allied visibility (Phase 2)
- **[Navigation](../active/gameplay/navigation.md)** — ship positions and roles determine sensor range
