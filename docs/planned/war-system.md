...
Relations themselves are updated by a separate faction relations processor (see [faction-system.md §2](../active/gameplay/faction-system.md)). The war processor only reads the current value and reacts to thresholds.
