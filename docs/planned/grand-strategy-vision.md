...
- **Determinism**: seeded RNG, no wall-clock in the tick. Cheap to maintain now, and it keeps Paradox-style lockstep multiplayer possible *someday* without being designed for.
