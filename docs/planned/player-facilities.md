...
**Depends on**: [Player Progression](./player-progression.md) (mid/late game gating), [System Traits](../active/gameplay/system-traits.md) (system traits, economy types), [Faction System](../active/gameplay/faction-system.md) (standing tax, war seizure)
...
- **[System Traits (active)](../active/gameplay/system-traits.md)** — system traits (placement requirements)
- **[Facilities](./facilities.md)** — faction-owned facilities (separate from player facilities)
- **[Faction System](../active/gameplay/faction-system.md)** — reputation (standing tax), war mechanics (seizure conditions)
- **[War System](./war-system.md)** — territory conquest, direct involvement tracking
- **[Navigation](../active/gameplay/navigation.md)** — danger pipeline (modified by Security Office, Customs Brokerage, Smuggler's Den)
- **[Economy](../active/gameplay/economy.md)** — market mechanics (modified by Trade Post spreads)
