...
**Depends on**: [Player Progression](./player-progression.md) (mid/late game gating), [System Traits](../active/system-traits.md) (system traits, economy types), [Faction System](../active/faction-system.md) (standing tax, war seizure)
...
- **[Faction System](../active/faction-system.md)** — reputation (standing tax), war mechanics (seizure conditions)
