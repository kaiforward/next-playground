...
Traits lay the groundwork for supply chain mechanics (see [Simulation Enhancements](./simulation-enhancements.md)):
...
- **[Simulation Enhancements](./simulation-enhancements.md)** — supply chain dependencies, production lines that leverage trait-gated resources
