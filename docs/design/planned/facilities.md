...
**Depends on**: [Faction System](./faction-system.md) (territory control, faction bonuses), [System Traits](../active/system-traits.md) (placement prerequisites, tier derivation)
...
- **[Faction System](./faction-system.md)** — territory control, war mechanics, government bonuses
