...
**Depends on**: [Faction System](../active/faction-system.md) (territory control, faction bonuses), [System Traits](../active/system-traits.md) (placement prerequisites, tier derivation)
...
|---|---|---|
| **Economic output** | High-quality production traits, rare resources (shipped — see [System Traits](../active/system-traits.md)) | Tier-3 asteroid belt = massive ore production |
...
| **Location** | Chokepoint position, border system, trade route junction (shipped — see [Universe](../active/universe.md)) | Gateway between two faction territories |
...
- **[System Traits (active)](../active/system-traits.md)** — placement prerequisites, tier derivation, the geological foundation
- **[Faction System](../active/faction-system.md)** — territory control, war mechanics, government bonuses
