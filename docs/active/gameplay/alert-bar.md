...
| important | Demand unservable | A shortfall no reachable supplier or local production can close. | The shortfall as cycles of the world's own demand, largest first; the raw quantity shown alongside. |
