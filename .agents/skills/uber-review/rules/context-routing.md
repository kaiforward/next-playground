...
| User journey | Changed `app/(game)` and `components` runtime hunks plus directly changed hooks they consume. | QueryBoundary/Suspense, shared UI/form primitives, dialog behaviour, lifted cached state, semantic UI, and interaction rules applicable to the changed surface. |
