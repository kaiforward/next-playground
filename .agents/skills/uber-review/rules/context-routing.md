...
| Tests | Changed testable runtime hunks and their changed/co-located tests. Include tick-harness analysis/metrics when gameplay behavior changes. | Engine purity/testing, real in-memory adapter/store tests, simulator-evidence practice, the node/jsdom project split, and meaningful-assertion guidance. |
